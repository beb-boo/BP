...
> **Scope:** ข้อกำหนดฉบับนี้ใช้สำหรับ **Admin ขององค์กร** (รพ.สต., โรงพยาบาล, คลินิก) ที่ลงทะเบียนใช้ BP Monitor ในนามองค์กร
> **แตกต่างจาก** `terms-of-service.md` ซึ่งใช้สำหรับ individual users (ชาวบ้าน, แพทย์, อสม.)
> Admin ต้องยอมรับข้อกำหนดนี้ก่อนใช้ features ขององค์กร
...
- **"องค์กร"** หมายถึง โรงพยาบาลส่งเสริมสุขภาพตำบล (รพ.สต.), โรงพยาบาล, คลินิก, หรือหน่วยงานอื่นที่ลงทะเบียนใช้บริการในฐานะองค์กร
...
1. ท่านเป็นบุคคลที่มีอำนาจตามกฎหมายในการผูกพันองค์กรกับข้อตกลงนี้ (เช่น ผู้อำนวยการ, ผู้จัดการ, หรือผู้ได้รับมอบอำนาจ)
...
[TBD — Pilot ไม่เสียค่าใช้จ่าย. เงื่อนไขการชำระเงิน การเรียกเก็บ การคืนเงิน จะระบุใน subscription agreement แยกต่างหากเมื่อ launch Production]
...
2. ผ่านช่องทาง: [security@yourdomain.com] หรือโทร [...]
3. เราจะร่วมมือในการ:
...
- เราจะดำเนินการตาม Breach Response Runbook
...
- องค์กรสามารถตรวจสอบซอร์สโค้ดได้ที่: https://github.com/kaebmoo/BP/
...
หากไม่ยอมรับ: บัญชีองค์กรอาจถูก restrict ใช้งานได้จำกัด (read-only)
...
- [Terms of Service](./terms-of-service.md) (สำหรับ individual)
