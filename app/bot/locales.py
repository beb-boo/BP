...
LOCALES = {
    "en": {
        ...
        "settings_reminder": "🔔 BP reminders: {status}",
        "btn_notif": "🔔 Reminders",
        "notif_title": "🔔 **Daily BP reminders**\n\nStatus: {status}\nTimes ({tz}): {times}\n\nTap a time below to remove it.",
        "notif_status_on": "✅ On",
        "notif_status_off": "🔕 Off",
        "notif_no_times": "—",
        "btn_notif_enable": "🔔 Turn on",
        "btn_notif_disable": "🔕 Turn off",
        "btn_notif_add": "➕ Add time",
        "notif_enter_time": "Send the time in **HH:MM** (24-hour), e.g. `06:30`\n\n/cancel to abort",
        "notif_time_invalid": "❌ Invalid time. Please send HH:MM (24-hour), e.g. 06:30",
        "notif_max_times": "❌ Maximum 6 reminder times.",
        "notif_saved": "✅ Saved.",
        ...
        "ocr_rate_limited": "⏳ The image-reading service is busy right now. Please wait a moment and try again, or enter values manually with /bp.",
        "ocr_unsupported_format": "❌ This image format isn't supported. Please send a JPEG or PNG photo.",
    ...
    "th": {
        ...
        "settings_reminder": "🔔 เตือนวัดความดัน: {status}",
        "btn_notif": "🔔 การแจ้งเตือน",
        "notif_title": "🔔 **เตือนวัดความดันประจำวัน**\n\nสถานะ: {status}\nเวลา ({tz}): {times}\n\nแตะที่เวลาเพื่อลบออก",
        "notif_status_on": "✅ เปิดอยู่",
        "notif_status_off": "🔕 ปิดอยู่",
        "notif_no_times": "—",
        "btn_notif_enable": "🔔 เปิดการเตือน",
        "btn_notif_disable": "🔕 ปิดการเตือน",
        "btn_notif_add": "➕ เพิ่มเวลา",
        "notif_enter_time": "พิมพ์เวลาแบบ **HH:MM** (24 ชั่วโมง) เช่น `06:30`\n\n/cancel เพื่อยกเลิก",
        "notif_time_invalid": "❌ รูปแบบเวลาไม่ถูกต้อง กรุณาพิมพ์ HH:MM (24 ชม.) เช่น 06:30",
        "notif_max_times": "❌ ตั้งได้สูงสุด 6 เวลา",
        "notif_saved": "✅ บันทึกแล้ว",
        ...
        "ocr_rate_limited": "⏳ ระบบอ่านรูปกำลังคิวเต็มชั่วคราว กรุณารอสักครู่แล้วส่งรูปใหม่อีกครั้ง หรือกรอกค่าด้วยตัวเองด้วย /bp",
        "ocr_unsupported_format": "❌ รูปแบบไฟล์ภาพนี้ไม่รองรับ กรุณาส่งเป็น JPEG หรือ PNG ครับ",
